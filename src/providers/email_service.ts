...
const CLIENT_ID =
  process.env.EMAIL_CLIENT_ID || '8906ba90-1c7b-4cc1-b9ce-b3ba00592071';
const CLIENT_SECRET =
  process.env.EMAIL_CLIENT_SECRET || 'tCl8Q~_ImfSzvtkrFJyMxWvPq~sE1yjmp66fTaCD';
const AAD_ENDPOINT =
...
const EMAIL_FROM_AD =
  process.env.EMAIL_FROM_AD || 'noreply.purespace@purehealth.ae';
...
export const sendNotification = async (
  ...
  const recipientAddresses = {
    to: [{address: toAddress, name: 'PureFamily-User'}],
  };
